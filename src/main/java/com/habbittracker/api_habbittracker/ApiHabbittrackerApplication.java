	...
	CommandLineRunner init(UserRepository userRepository) {
		return args -> {
			...
			UserEntity userSantiago = UserEntity.builder()
					...
					.email("santiago@empresa.com")  // Campo email
					.userEmail("santiago.personal@gmail.com")  // Campo userEmail
					.isEnabled(true)
			...
			UserEntity userDaniel = UserEntity.builder()
					.username("daniel")
					.password("$2a$10$cMY29RPYoIHMJSuwRfoD3eQxU1J5Rww4VnNOUOAEPqCBshkNfrEf6")
					.email("daniel@empresa.com")  // Campo email
					.userEmail("daniel.personal@gmail.com")  // Campo userEmail
					.isEnabled(true)
					.accountNoExpired(true)
					.accountNoLocked(true)
					.credentialNoExpired(true)
			...
			UserEntity userAndrea = UserEntity.builder()
					.username("andrea")
					.password("$2a$10$cMY29RPYoIHMJSuwRfoD3eQxU1J5Rww4VnNOUOAEPqCBshkNfrEf6")
					.email("andrea@empresa.com")  // Campo email
					.userEmail("andrea.personal@gmail.com")  // Campo userEmail
					.isEnabled(true)
					.accountNoExpired(true)
					.accountNoLocked(true)
					.credentialNoExpired(true)
			...
			UserEntity userAnyi = UserEntity.builder()
					.username("anyi")
					.password("$2a$10$cMY29RPYoIHMJSuwRfoD3eQxU1J5Rww4VnNOUOAEPqCBshkNfrEf6")
					.email("sandovaljosearmando69@gmail.com")  // Campo email
					.userEmail("anyi.sandovaljosearmando69@gmail.com")  // Campo userEmail
					.isEnabled(true)
					.accountNoExpired(true)
					.accountNoLocked(true)
					.credentialNoExpired(true)
